...
public class Main
{
    ...
    static Search ai = new IterativePrunedSearch(2800,10);
    ...
    public static void main(String[] args) throws Exception
    {
    	...
    	System.out.println("Enter gameID (0 for new game):");
    ...
    static void play(String gameID, int offset) throws Exception
    {
        ...
        int player = isOpener ? Search.PLAYER_ONE : Search.PLAYER_TWO;
        ...
        while(true) {
            ...
            if(gameState != GAME_STATE_FINISHED && ((start <= moveState && moveState <= end) || moveState == MOVE_STATE_YOUR_TURN)) {
            	...
            	if (moveState != MOVE_STATE_YOUR_TURN) {
                    ...
                    s.doMove(opponentMove);
                    System.out.println("Gegner waehlte: " + moveState + " /\t" + s.getStore1() + " - " + s.getStore2());
                ...
                if(nextMove >= 0) {
                	s.doMove(nextMove);
                    System.out.println("Waehle Feld: " + (nextMove+1) + " /\t" + s.getStore1() + " - " + s.getStore2());
                    System.out.println(s.toString() + "\n\n");
                    // call API with move
